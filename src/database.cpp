...
com::example::database::database(const std::string & name, bool clear, int flags, bool foreign_keys, const std::string & vfs, odb::details::transfer_ptr<odb::sqlite::connection_factory> transfer )
